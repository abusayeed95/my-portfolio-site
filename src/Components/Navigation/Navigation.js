        ...
        <Navbar className="navigation" variant="dark" expand="lg">
            ...
            <Navbar.Collapse id="navigation">
                <Nav className="ml-auto">
                    ...
                    <a className="nav-link green download-cv" href="https://drive.google.com/file/d/16CRHp_QOdqXOJT4fq-MLXSv4oamYWE-_/view?usp=sharing" target="_blank">Download CV</a>
                </Nav>
            </Navbar.Collapse>
        </Navbar>
    );
